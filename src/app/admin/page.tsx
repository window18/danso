...
export default function Admin() {
  ...
  return (
    <div className="pl-26 flex gap-7 admin max-lg:pl-10 max-xl:pl-15">
      <div className="w-full flex flex-col gap-4 py-5">
        <Button
          className="w-[175px] h-[45px] bg-[#3060FE] hover:bg-[#3060FE]/90 text-white font-black text-[14px] flex items-center gap-2 cursor-pointer"
          onClick={() => setActiveMenu(prev => !prev)}
        >
          <Plus className="w-5 h-5" />
          Добавить камеру
        </Button>
        <div className="w-full h-full bg-[#E3E3E3] dark:bg-[#0F1827] rounded-md">
                        ...
                        <div className="flex flex-col gap-5">
                          ...
                          <div className="flex flex-col gap-3">
                            ...
                            <p className="text-[9px] font-medium w-[398px] mt-5 dark:text-white">
                              Выберите необходимый профиль для включения записи
                              в архив. Вы можите создать профиль в разделе
                              ‘’Профили записи’’ конфигуратора, чтоб
                              определиться Расписание записи,настроить пораметры
                              прожевания и выберите необходимый поток для
                              записи.
                            </p>
                          </div>
                          <div className="mt-10">
